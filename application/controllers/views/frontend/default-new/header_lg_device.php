    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0 align-items-center">
           <li class="nav-item" style="margin-right:5px">
                 ...
                 <li class="nav-item" style="margin-right:5px">
                    <a class="nav-link header-dropdown px-3 text-nowrap" href="<?php echo site_url('home/webinar'); ?>" id=""><?php echo site_phrase('Webinar'); ?></a>
                </li>
        <li class="nav-item">
        ...
        <div class="quiz-container">
            ...
            <form id="quizForm">
                ...
                <div class="navigation">
                    ...
                    <button type="button" id="submitButton" onclick="calculateScore()"
...
<div id="popupAssessResult" class="popup">
    <div class="popup-content">
        ...
        <div class="row">
          <div class="col-12 " id="course1" >
          <!-- •	Less than 20 percent -->
          <h1>Elementary Level </h1>
          </div>

          <div class="col-12 course2" id="course2" >
          <!-- •	Up to 30 percent -->
          <h1>Basic to advanced Level </h1>
          </div>

          <div class="col-12 course3" id="course3" hidden>
          <!-- •	Up to 60 percent -->
          <h1>Intermediate Level  </h1>
          </div>

          <div class="col-12 course4" id="course4" hidden>
...
function calculateScore() {
    ...
    document.getElementById("course1").style.display = "flex";
    }
    if(score>2 && score<=3){
      console.log('Basic to advanced Level  ');
      document.getElementById("course2").style.display = "flex";
    }else{
      console.log('Basic to advanced Level  ');
      document.getElementById("course3").style.display = "flex";
    }
