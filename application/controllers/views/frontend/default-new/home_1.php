                                    ...
                                    <div class="popover-btns">
                                        ...
                                        <?php else: ?>
                                            ...
                                            <?php else : ?>
                                                ...
                                                <a id="add_to_cart_btn_latest_course<?php echo $latest_course['id']; ?>" class="purchase-btn align-items-center me-auto <?php if(in_array($latest_course['id'], $cart_items)) echo 'd-hidden'; ?>" href="<?php echo site_url('home/course/' . rawurlencode(slugify($latest_course['title'])) . '/' . $latest_course['id']); ?>" onclick="actionTo('<?php echo site_url('home/course/' . rawurlencode(slugify($latest_course['title'])) . '/' . $latest_course['id']); ?>'); ?>'); ">
...
<section class="">
    <div class="container">
        <div class="webinarSec">
           <a href="">
            <img src="<?php echo base_url('assets/frontend/default-new/image/webiBanner2.png')?>" width="100%" alt="">
           </a>
        </div>
    </div>
